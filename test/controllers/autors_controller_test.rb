...
class AutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create autor" do
    assert_difference('Autor.count') do
      post autors_url, params: { autor: { edad: @autor.edad, libro: @autor.libro, nombre: @autor.nombre } }
    end
  ...
  test "should update autor" do
    patch autor_url(@autor), params: { autor: { edad: @autor.edad, libro: @autor.libro, nombre: @autor.nombre } }
